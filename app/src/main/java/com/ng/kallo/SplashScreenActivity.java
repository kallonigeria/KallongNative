...
import com.ng.kallo.network.apis.ConfigurationApi;
import com.ng.kallo.network.model.config.ApkUpdateInfo;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.kallobg);
